...
class DifferentLenderDebtException(debtInfo: DebtInfo, thisLenderId: Long) :
    Exception(
        "Trying to change debt $debtInfo that does not correspond to this as lender with id $thisLenderId. " +
