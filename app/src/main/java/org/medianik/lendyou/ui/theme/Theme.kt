package org.medianik.lendyou.ui.theme
...
private val LightColorPalette = LendyouColors(
    brand = Shadow5,
    brandSecondary = Ocean3,
    uiBackground = Neutral0,
    uiForeground = Shadow9,
    uiBorder = Neutral4,
    ...
    error = FunctionalRed,
    gradient6_1 = listOf(Shadow7, Shadow6),
    gradient6_2 = listOf(Shadow6, Shadow7),
    gradient3_1 = listOf(Shadow2, Ocean3, Shadow4),
    gradient3_2 = listOf(Rose2, Lavender3, Rose4),
    gradient2_1 = listOf(Ocean5, Rose5),
...
private val DarkColorPalette = LendyouColors(
    ...
    gradient6_1 = listOf(Shadow11, Shadow9),
    gradient6_2 = listOf(Shadow9, Shadow11),
    gradient3_1 = listOf(Shadow9, Ocean7, Shadow5),
    gradient3_2 = listOf(Rose8, Lavender7, Rose11),
    gradient2_1 = listOf(Ocean3, Rose4),
...
object LendyouTheme {
    val colors: LendyouColors
        @Composable
        get() = LocalLendyouColors.current
}

/**
 * Lendyou custom Color Palette
 */
@Stable
class LendyouColors(
    ...
    var uiBackground by mutableStateOf(uiBackground)
        private set
    var uiForeground by mutableStateOf(uiForeground)
        private set
    ...
    fun update(other: LendyouColors) {
        ...
        uiForeground = other.uiForeground
    ...
    fun copy(): LendyouColors = LendyouColors(
...
@Composable
fun ProvideLendyouColors(
    colors: LendyouColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalLendyouColors provides colorPalette, content = content)
}

private val LocalLendyouColors = staticCompositionLocalOf<LendyouColors> {
    error("No LendyouColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [emptyColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [LendyouTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
    ...
    primary = emptyColor,
    primaryVariant = emptyColor,
    secondary = emptyColor,
    secondaryVariant = emptyColor,
